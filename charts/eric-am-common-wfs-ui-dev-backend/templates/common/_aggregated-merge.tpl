...
{{- define "eric-am-common-wfs-ui-dev-backend.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-am-common-wfs-ui-dev-backend.mergeAnnotations" -}}
  {{- include "eric-am-common-wfs-ui-dev-backend.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) | trim}}
{{- end -}}

{{- define "eric-am-common-wfs-ui-dev-backend.mergeLabels" -}}
  {{- include "eric-am-common-wfs-ui-dev-backend.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) | trim }}
{{- end -}}
