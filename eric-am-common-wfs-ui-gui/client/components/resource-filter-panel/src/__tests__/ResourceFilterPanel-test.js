 ...
 */
/**
 * Integration tests for <e-resource-filter-panel>
 */
import { assert } from "chai";
import "../ResourceFilterPanel";
import { allInShadow, injectHTMLElement } from "../../../../../test/utils";

describe("ResourceFilterPanel Component Tests", () => {
  let container;
  let inject;
  before(() => {
  ...
  describe("Basic component setup", () => {
    it("should create a new <e-resource-filter-panel>", async () => {
      const customElement = await inject("<e-resource-filter-panel></e-resource-filter-panel>");
