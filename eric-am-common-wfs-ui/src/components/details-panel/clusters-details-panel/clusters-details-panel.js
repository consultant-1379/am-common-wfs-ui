...
// helpers
import { DETAILS_SCHEMA } from '../../../apps/clusters/clusters.config.js';

// components
import DetailsPanelItem from '../_components/details-panel-item/details-panel-item.js';

// styles
import style from './clusters-details-panel.css';
...
export default class ClustersDetailsPanel extends LitComponent {
  ...
  /**
   * Render the <e-clusters-details-panel> component. This function is called each time a
   * prop changes.
   */
  render() {
    ...
    const noClusterSelected = html`<span>No cluster selected</span>`;
...
/**
 * @property {Object} data - model of selected cluster
 */
